...
# ===================Python Variables=======================
menu_category = ["2-Wheelers", "3-Wheelers",
                 "4-Wheelers", "Light Goods", "Bus / Trucks", "Multi Axiel Vechile"]

menu_category_dict = {"2 Wheelers": "2-Wheelers.txt",
                      "3 Wheelers": "3-Wheelers.txt",
                      "4 Wheelers": "4-Wheelers.txt",
                      "Light Goods": "Light-Goods.txt",
                      "Bus / Trucks": "Bus-Trucks.txt",
                      "Multi Axiel Vechile": "Multi-Axiel-Vechile.txt"}
...
root.title("Welcome to Food Plaza")
...
title_label = Label(title_frame, text="FOOD  PLAZA", font=(
    "times new roman", 20, "bold"), bg="cyan", fg="red", pady=5)
title_label.pack()
...
menu_label = Label(menu_frame, text="TOLL Details",
...
combo_lable = Label(menu_category_frame, text="Type of Vechile",
